...
/***/ "./src/app/portfolio/component/profile.component.css":
/*!***********************************************************!*\
  !*** ./src/app/portfolio/component/profile.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/portfolio/component/profile.component.html":
/*!************************************************************!*\
  !*** ./src/app/portfolio/component/profile.component.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<a [href]=\"profile.url ? profile.url : null\" target=\"_blank\">\r\n  <ng-container [ngSwitch]=\"profile.network\">\r\n    <!--PDF-->\r\n    <i *ngSwitchCase=\"'pdf'\" class=\"fab far fa-file-pdf\"></i>\r\n    <!--LinkedIn-->\r\n    <i *ngSwitchCase=\"'linked-in'\" class=\"fab fa-linkedin-in\"></i>\r\n    <!--Twitter-->\r\n    <i *ngSwitchCase=\"'twitter'\" class=\"fab fa-twitter\"></i>\r\n    <!--Github-->\r\n    <i *ngSwitchCase=\"'github'\" class=\"fab fa-github\"></i>\r\n    <!--Default-->\r\n    <i *ngSwitchDefault class=\"fab far fa-star\"></i>\r\n  </ng-container>\r\n</a>\r\n"

/***/ }),

/***/ "./src/app/portfolio/component/profile.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/portfolio/component/profile.component.ts ***!
  \**********************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _resume_profile_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../resume/profile.model */ "./src/app/portfolio/resume/profile.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfileComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _resume_profile_model__WEBPACK_IMPORTED_MODULE_1__["Profile"])
    ], ProfileComponent.prototype, "profile", void 0);
    ProfileComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'profile-component',
            template: __webpack_require__(/*! ./profile.component.html */ "./src/app/portfolio/component/profile.component.html"),
            styles: [__webpack_require__(/*! ./profile.component.css */ "./src/app/portfolio/component/profile.component.css")]
        })
    ], ProfileComponent);
...
/* harmony import */ var _portfolio_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./portfolio.data */ "./src/app/portfolio/portfolio.data.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PortfolioComponent = /** @class */ (function () {
    function PortfolioComponent(titleService) {
        this.resume = _portfolio_data__WEBPACK_IMPORTED_MODULE_2__["PortfolioData"].createResume();
        this.color = _portfolio_data__WEBPACK_IMPORTED_MODULE_2__["PortfolioData"].getColor();
...
/* harmony import */ var _resume_work_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./resume/work.model */ "./src/app/portfolio/resume/work.model.ts");
/* harmony import */ var _resume_basics_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resume/basics.model */ "./src/app/portfolio/resume/basics.model.ts");
/* harmony import */ var _resume_resume_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./resume/resume.model */ "./src/app/portfolio/resume/resume.model.ts");
/* harmony import */ var _resume_profile_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resume/profile.model */ "./src/app/portfolio/resume/profile.model.ts");
...
var PortfolioData = /** @class */ (function () {
    ...
    PortfolioData.createResume = function () {
        // == Resume == //
        var resume = new _resume_resume_model__WEBPACK_IMPORTED_MODULE_2__["Resume"]();
        resume.basics = PortfolioData.createBasics();
        resume.work = [PortfolioData.createTactiv(), PortfolioData.createUq()];
        // Return
        return resume;
    };
    ...
    PortfolioData.createBasics = function () {
        var basics = new _resume_basics_model__WEBPACK_IMPORTED_MODULE_1__["Basics"]();
        basics.firstName = 'Jacob';
        basics.lastName = 'Klein';
        basics.profiles = this.getProfiles();
        basics.picture = 'assets/img/profile.jpg';
        basics.title = 'Brisbane Web Developer';
        basics.website = 'http://jacobklein.github.io';
        basics.email = 'jacob23791@gmail.com';
        return basics;
    };
    PortfolioData.getProfiles = function () {
        return [
            new _resume_profile_model__WEBPACK_IMPORTED_MODULE_3__["Profile"]('github', 'JacobKlein', 'https://github.com/JacobKlein'),
            new _resume_profile_model__WEBPACK_IMPORTED_MODULE_3__["Profile"]('linked-in', 'Jacob Klein', 'https://www.linkedin.com/in/jacob-klein-8062a0a1'),
            new _resume_profile_model__WEBPACK_IMPORTED_MODULE_3__["Profile"]('pdf', null, 'https://drive.google.com/file/d/1LRhQS1wZnkxEr0K36msc7zGg-BtejC_z/view')
        ];
    };
    PortfolioData.createTactiv = function () {
        var tactiv = new _resume_work_model__WEBPACK_IMPORTED_MODULE_0__["Work"]();
        ...
        tactiv.highlights = [
            ...
            'Implemented document management service that processed uploading, version management, metadata and remoting authoring',
    ...
    PortfolioData.createUq = function () {
        var uq = new _resume_work_model__WEBPACK_IMPORTED_MODULE_0__["Work"]();
...
/* harmony import */ var _component_profile_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/profile.component */ "./src/app/portfolio/component/profile.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var components = [
    ...
    _component_profile_component__WEBPACK_IMPORTED_MODULE_5__["ProfileComponent"],
...
/***/ "./src/app/portfolio/resume/basics.model.ts":
/*!**************************************************!*\
  !*** ./src/app/portfolio/resume/basics.model.ts ***!
  \**************************************************/
...
/***/ "./src/app/portfolio/resume/profile.model.ts":
/*!***************************************************!*\
  !*** ./src/app/portfolio/resume/profile.model.ts ***!
  \***************************************************/
...
/***/ "./src/app/portfolio/resume/resume.model.ts":
/*!**************************************************!*\
  !*** ./src/app/portfolio/resume/resume.model.ts ***!
  \**************************************************/
...
/***/ "./src/app/portfolio/resume/work.model.ts":
/*!************************************************!*\
  !*** ./src/app/portfolio/resume/work.model.ts ***!
  \************************************************/
...
module.exports = __webpack_require__(/*! D:\Users\Jacob\Projects\portfolio\src\main.ts */"./src/main.ts");
